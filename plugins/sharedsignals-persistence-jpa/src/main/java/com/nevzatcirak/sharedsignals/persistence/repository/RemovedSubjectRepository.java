...
public interface RemovedSubjectRepository extends JpaRepository<RemovedSubjectEntity, Long> {
    ...
    Optional<RemovedSubjectEntity> findActiveGracePeriod(String streamId, String subjectHash, Instant now);
    ...
    List<RemovedSubjectEntity> findExpiredGracePeriods(Instant now);
