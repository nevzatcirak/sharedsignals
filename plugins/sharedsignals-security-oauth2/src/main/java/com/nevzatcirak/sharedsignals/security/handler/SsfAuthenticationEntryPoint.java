...
public class SsfAuthenticationEntryPoint implements AuthenticationEntryPoint {

    private final ObjectMapper objectMapper;
    private final String issuerUrl;

    public SsfAuthenticationEntryPoint(ObjectMapper objectMapper, String issuerUrl) {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        // Use the standardized enum constant for SSF-3003
